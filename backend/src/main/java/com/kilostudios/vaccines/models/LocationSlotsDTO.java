...
public class LocationSlotsDTO {
	...
	public LocationSlotsDTO() {
		
	}
	
	public LocationSlotsDTO(String location_code, String location_name, Integer type, Integer slots_open, Date appt_date, Integer delta, Integer uniqid) {
